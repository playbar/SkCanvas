...
static const float kWidth = SkIntToScalar(640);
static const float kHeight = SkIntToScalar(480);
...
protected:
    ...
    virtual bool onSendClickToChildren(float x, float y, unsigned modi) SK_OVERRIDE {
        return false;
    }
