...
void SkDumpCanvas::drawBitmap(const SkBitmap& bitmap, float x, float y,
                               const SkPaint* paint) {
    SkString str;
    bitmap.toString(&str);
...
void SkDumpCanvas::drawText(const void* text, size_t byteLength, float x,
