...
SkDropShadowImageFilter::SkDropShadowImageFilter(float dx, float dy, float sigma, SkColor color, SkImageFilter* input)
    : INHERITED(input)
    , fDx(dx)
    , fDy(dy)
    , fSigmaX(sigma)
...
SkDropShadowImageFilter::SkDropShadowImageFilter(float dx, float dy, float sigmaX, float sigmaY, SkColor color, SkImageFilter* input, const CropRect* cropRect)
