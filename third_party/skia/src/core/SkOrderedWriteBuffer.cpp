...
void SkOrderedWriteBuffer::writeScalar(float value) {
    fWriter.writeScalar(value);
}

void SkOrderedWriteBuffer::writeScalarArray(const float* value, uint32_t count) {
    fWriter.write32(count);
    fWriter.write(value, count * sizeof(float));
}
