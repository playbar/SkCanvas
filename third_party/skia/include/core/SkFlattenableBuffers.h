...
public:
	...
	virtual bool readScalarArray(float* values, size_t size) = 0;
...
public:
    ...
    virtual SkOrderedWriteBuffer* getOrderedBinaryBuffer() { return NULL; }

    // primitives
    virtual void writeByteArray(const void* data, size_t size) = 0;
    virtual void writeBool(bool value) = 0;
    virtual void writeFixed(SkFixed value) = 0;
	virtual void writeScalar(float value) = 0;
	virtual void writeScalarArray(const float* value, uint32_t count) = 0;
