...
public:
    ...
    public:
        ...
        SkPoint* growForVerb(int /*SkPath::Verb*/ verb, float weight = 0) {
...
public:
    ...
    */
    ...
    const float* conicWeights() const { return fConicWeights.begin(); }
    const float* conicWeightsEnd() const { return fConicWeights.end(); }
...
private:
     ...
     */
    SkPoint* growForRepeatedVerb(int /*SkPath::Verb*/ verb, int numVbs, float** weights);
     ...
     * uninitialized.
     */
    SkPoint* growForVerb(int /*SkPath::Verb*/ verb, float weight);
