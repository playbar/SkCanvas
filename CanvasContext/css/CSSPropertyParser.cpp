...
CSSPropertyParser::CSSPropertyParser(OwnPtr<CSSParserValueList>& valueList,
	...
	Vector<CSSProperty, 256>& parsedProperties, bool& hasFontFaceOnlyValues)
...
bool CSSPropertyParser::parseIntegerOrStringFromGridPosition(RefPtr<CSSPrimitiveValue>& numericValue, RefPtr<CSSPrimitiveValue>& gridLineName)
{
    CSSParserValue* value = m_valueList->current();
...
PassRefPtr<CSSPrimitiveValue> CSSPropertyParser::parseColor(CSSParserValue* value)
{
