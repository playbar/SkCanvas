...
bool Scene::VisitNode::visitInitNode(Node* node)
{
	return true;
}

bool Scene::VisitNode::visitDrawNode(Node *node)
{
	return true;
}

bool Scene::VisitNode::visitDrawNode(Node *node, void* cookie)
{
	return true;
}
...
void Scene::visit(VisitNode *instance, bool (VisitNode::*visitMethod)(Node*))
{
...
void Scene::visit(VisitNode* instance, bool(VisitNode::*visitMethod)(Node*, void*), void* cookie)
{
	for (Node* node = getFirstNode(); node != NULL; node = node->getNextSibling())
	{
...
void Scene::visitNode(Node* node, VisitNode* instance, bool (VisitNode::*visitMethod)(Node*))
{
	// Invoke the visit method for this node.
...
void Scene::visitNode(Node* node, VisitNode* instance, bool (VisitNode::*visitMethod)(Node*, void*), void* cookie)
{
	// Invoke the visit method for this node.
